...
fsb_trend_report_config = reportConfig(
    title="FSB Trend report",
    function="sysproduction.reporting.fsb_trend_report.fsb_trend_report",
    output="email",
)
...
report_config_defaults = dict(
    ...
    # fsb_trend_report=fsb_trend_report_config,
)
