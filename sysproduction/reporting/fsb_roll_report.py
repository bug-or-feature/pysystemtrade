...
def fsb_roll_report(
    ...
    formatted_output.append(
        body_text(
            "roll_exp is days until preferred roll set by roll parameters. price_exp is days until price contract expires, "
            "carry_exp is days until carry contract expires"
        )
    )
