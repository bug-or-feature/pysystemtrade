...
from sysobjects.production.optimal_positions import simpleOptimalPosition, listOfOptimalAndCurrentPositionsAcrossInstrumentStrategies, listOfOptimalPositionsAcrossInstrumentStrategies, instrumentStrategyAndOptimalPosition
...
class dataOptimalPositions(productionDataLayerGeneric):
    ...
    def get_current_optimal_position_for_instrument_strategy(
        ...
        if raw_positions:
            use_instrument_strategy = instrument_strategy_with_raw_tag(instrument_strategy)
        else:
...
def is_not_raw_optimal_position_and_instrument_strategy\
    (optimal_position_and_instrument_strategy:
        instrumentStrategyAndOptimalPosition) -> bool:

   return is_not_raw_instrument_strategy(optimal_position_and_instrument_strategy.instrument_strategy)
...
def instrument_strategy_with_raw_tag(instrument_strategy: instrumentStrategy) -> instrumentStrategy:
    ...
    new_instrument_strategy = instrumentStrategy(strategy_name = strategy_name,
