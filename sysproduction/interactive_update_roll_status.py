...
def update_roll_status_manual_cycle(api: ReportingApiFsb, data: dataBlob):
...
def update_roll_status_auto_cycle_manual_decide(api: ReportingApiFsb, data: dataBlob):
...
def update_roll_status_auto_cycle_manual_confirm(api: ReportingApiFsb, data: dataBlob):
    days_ahead = get_days_ahead_to_consider_when_auto_cycling()
...
def update_roll_status_full_auto(api: ReportingApiFsb, data: dataBlob):
    days_ahead = get_days_ahead_to_consider_when_auto_cycling()
    instrument_list = get_list_of_instruments_to_auto_cycle(
        api.data, days_ahead=days_ahead
    )
