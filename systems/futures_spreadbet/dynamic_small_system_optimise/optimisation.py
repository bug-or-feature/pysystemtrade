...
from systems.futures_spreadbet.dynamic_small_system_optimise.data_for_optimisation import (
    dataForOptimisation,
)
...
class objectiveFunctionForGreedy:
    ...
    def is_tracking_error_of_prior_smaller_than_buffer(self) -> bool:
        ...
        if tracking_error_smaller_than_buffer:
            self.log.debug(
                "Tracking error of current positions vs unrounded optimal is %.4f smaller than buffer %.4f, no trades needed"
