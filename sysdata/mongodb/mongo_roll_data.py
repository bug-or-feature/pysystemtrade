...
class mongoRollParametersData(rollParametersData):
    ...
    def __init__(self, mongo_db = None, log=logtoscreen("mongoRollParametersData")):
        ...
        self.name = "simData connection for futures roll parameters, %s" % repr(self._mongo)
    ...
    def _delete_roll_parameters_data_without_any_warning_be_careful(self, instrument_code):
