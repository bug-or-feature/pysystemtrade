...
class CsvFsbContractPriceData(csvFuturesContractPriceData):
    ...
    def __init__(self, datapath=arg_not_supplied, log=logtoscreen("csvFuturesContractPriceData"),
                 config: ConfigCsvFuturesPrices = arg_not_supplied):

        prod_config = get_production_config()
        ig_path = get_filename_for_package(prod_config.get_element_or_missing_data('ig_path'))
        ...
        super().__init__(datapath=ig_path, log=logtoscreen("csvFuturesContractPriceData"), config=pd_config)
